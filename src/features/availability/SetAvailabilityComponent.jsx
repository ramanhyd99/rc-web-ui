    ...
    <>
      <form>
        <div className="grid sm:grid-cols-6  border-b border-gray-900/10 pb-12">
          <div
            className="space-y-12 sm:col-span-4"
          ...
          >
            <div className=" pb-0">
              <h2 className="text-base font-semibold leading-7 text-gray-900">
                ...
                <span
                  className={`mt-2 inline-flex text-center text-sm rounded-md bg-green-50 px-2 py-1  font-medium text-green-700 ring-1 ring-inset ring-green-600/20`}
                >
                  Fri, 26 May
                </span>
              </h2>
