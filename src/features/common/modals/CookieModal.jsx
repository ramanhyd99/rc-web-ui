    ...
    <>
      {showCookieBanner && (
        <div className="flex justify-center mr-2">
          <div class="bg-teal-50 rounded-2xl z-10 fixed bottom-3">
            <div class="mx-auto max-w-screen-2xl">
              {/* <div className="flex justify-end pr-3 pt-2"><XMarkIcon className="h-6"/></div> */}
              <div class="relative flex flex-wrap rounded-lg p-8 pb-6 shadow-lg sm:flex-nowrap sm:items-center sm:justify-center sm:gap-3 sm:pr-8 md:px-8">
                ...
                <button
                  ...
                  class="order-last inline-block w-full whitespace-nowrap rounded-lg bg-blue-600 px-4 py-2 text-center text-xs font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-blue-500 focus-visible:ring active:bg-blue-500 sm:order-none sm:w-auto md:text-sm"
                >
                  Accept Cookies
                </button>
