...
export default function ContactUsModal(props) {
  ...
  const copyToClipboard = () => {
    navigator.clipboard.writeText("+91-7975897538");
  };
                ...
                <div className="bg-white px-6 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="">
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      <Dialog.Title
                        as="h3"
                        className="font-semibold text-center leading-6 text-gray-900 text-xl"
                      >
                        Contact Us
                      </Dialog.Title>
                      <div className="mt-2">
                          ...
                          <Popover placement="right">
                            <PopoverHandler>
                              <button
                                ...
                                className="mb-3 ml-4 text-lg hover:text-blue-400"
                              >
                                +91-7975897538
                              </button>
                            </PopoverHandler>
                            <PopoverContent>
                              <span className="relative z-50">copied!</span>
                            </PopoverContent>
                          </Popover>
                        </div>
                      </div>
