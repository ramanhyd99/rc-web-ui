...
import { Link } from "react-router-dom";
  import { useGetAllSessionsByDateQuery, useGetAllSessionsForUserQuery } from "../../../apis/rtk-apis";
  ...
  const BookingsByDateTable = ({ date }) => {
    ...
    return (
      <>
        {isFetching && <Spinner className="h-5" />}
     ...
     `}
                              ...
                              <span><Link to={"/client?id=" + user_id}> <ArrowTopRightOnSquareIcon className="h-5"/></Link></span>
  ...
  export default BookingsByDateTable;
