...
const sortOptions = [
  { name: "AM to PM", href: "#", current: true },
  { name: "PM to AM", href: "#", current: false },
];
const subCategories = [
  { name: "This month", href: "#" },
  { name: "Next month", href: "#" },
];
const filters = [
  {
    id: "mode",
...
const Booking = () => {
  ...
  const Menus = [
    { title: "Booking", src: CalendarDaysIcon },
    { title: "Booking", src: CalendarDaysIcon },
    { title: "Booking", src: CalendarDaysIcon, gap: true },
    { title: "Booking", src: CalendarDaysIcon },
    { title: "Booking", src: CalendarDaysIcon },
    // { title: "My Sessions", src: "Chat" },
    // { title: "My Assignments", src: "User" },
    // { title: "My Availability ", src: "Calendar", gap: true },
    // { title: "My Clients", src: "Search" },
  ];
                          ...
                          >
                            ...
                            <li class="text-gray-400">
                              <span class="text-gray-600">
                                ...
                                days between successive sessions.
                              </span>
                            </li>
                          </ul>
                        </span>
