...
const HowItWorks = ({ className }) => {
  return (
    <section className={`text-gray-600 body-font ${className}`}>
      <div className="container px-5 py-0 mx-auto sm:flex flex-wrap">
          ...
          <div className="lg:w-1/3 md:w-1/2 w-full md:pr-10 md:py-6">
            ...
            >
              <div className="flex relative pb-12">
                ...
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-pink-200 ring-4 ring-pink-100  inline-flex items-center justify-center text-white relative z-10">
                  <svg
            ...
            >
              <div className="flex relative pb-12">
                ...
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-green-100 inline-flex items-center justify-center text-white relative z-10">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <div className="flex relative">
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-blue-500  ring-4 ring-blue-100 inline-flex items-center justify-center text-white relative z-10">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
